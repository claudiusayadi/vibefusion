...
export const envSchema = z.object({
	...
	TMDB_POSTER_URL: z.string().min(1, 'TMDB poster URL is required'),
	TMDB_BACKDROP_URL: z.string().min(1, 'TMDB backdrop URL is required'),
...
export const env = envSchema.parse({
	...
	TMDB_POSTER_URL: Bun.env.TMDB_POSTER_URL,
	TMDB_BACKDROP_URL: Bun.env.TMDB_BACKDROP_URL,
