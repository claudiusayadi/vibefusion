    ...
    const fetchMovie = async () => {
      try {
        ...
        if (storedMovies) {
          ...
          const foundMovie = movies.find((m: Movie) => m.id.toString() === params.id);
          if (foundMovie) {
            setMovie(foundMovie);
          }
        }
  ...
  if (!movie) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900 text-white flex flex-col items-center justify-center p-4">
        ...
        <Button onClick={() => router.push('/')} variant="default" className="bg-purple-600 hover:bg-purple-700">
          Return to Home
        </Button>
      </div>
    );
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          >
            ...
            {movie.video_url && (
              ...
              >
                <Button
                  className="w-full sm:w-auto flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white rounded-full py-6 px-8"
                >
